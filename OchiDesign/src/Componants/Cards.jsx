...
const Cards = () => {
  return (
    <div className="w-full h-screen bg-zinc-900 flex items-center px-32 gap-6">
      <div className="Card-Container w-1/2 h-[50vh]">
        <div className="w-full relative rounded-xl h-full flex justify-center items-center bg-[#004D43]">
        <div className="logo">
       
       
       
       
        <svg width="72" height="30">
        ...
        <div className="absolute bottom-0 left-0 ml-8 mb-6 p-6 rounded-full py-2 bg-transparent border border-[#CDEA68]">
           <h2 className="text-[#CDEA68]"> @2019-2022</h2>
        </div>
        </div>
      </div>
      <div className="Card-Container h-[50vh] flex gap-4 w-1/2">
        <div className="w-1/2 relative flex justify-center items-center rounded-xl h-full bg-[#212121]">
        <div className="logo">
        <img src="https://ochi.design/wp-content/uploads/2022/04/logo002.svg" alt="" />
        </div>
        <div className="absolute bottom-0 left-0 ml-8 mb-6 p-6 rounded-full py-2 bg-transparent border border-white">
           <h2 className="text-white">RATING 5.0 ON CLUTCH</h2>
        </div>
        ...
        <div className="w-1/2 relative flex justify-center items-center rounded-xl h-full bg-[#212121]">
        <div className="logo">
        <img className="h-[90px]" src="https://ochi.design/wp-content/uploads/2022/04/logo003.png" alt="" />
        </div>
        <div className="absolute bottom-0 left-0 ml-8 mb-6 p-6 rounded-full py-2 bg-transparent border border-white">
           <h2 className="text-white">BUSINESS BOOTCAMP ALUMNI</h2>
        </div>
